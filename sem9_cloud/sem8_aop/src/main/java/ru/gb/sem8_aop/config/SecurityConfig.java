...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests((authorize) -> authorize
			.requestMatchers("/css/**", "/shop/css/**", "/favicon.ico", "/img/**", "/shop/img/**", "/", "/shop", "/shop/index","/login").permitAll()
			.requestMatchers("/shop/user", "/shop/product").hasAnyRole("USER")
			.requestMatchers("/shop/admin", "/shop/product","/shop/product_edit").hasAnyRole("ADMIN")
